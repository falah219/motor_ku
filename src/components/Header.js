    ...
    <header>
      ...
      <nav className="bg-white border-gray-200 dark:bg-gray-900 border-b-2 dark:border-b-1 dark:border-gray-900 sticky top-0">
        ...
        <Link to="/" className="flex items-center">
            ...
            <span className="self-center text-4xl font-semibold whitespace-nowrap dark:text-white">MotorKu</span>
        </Link>
        <div id="mobile-nav" className="flex other2:order-2">
          ...
          <div className={`${hidden ? "hidden" : "" } items-center justify-between w-full other2:flex other2:w-auto other2:order-1`} id="navbar-search">
            ...
            <ul className="flex flex-col other2:ml-60 p-8 other2:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 other2:flex-row other2:space-x-10 other2:mt-0 other2:border-0 other2:bg-white dark:bg-gray-800 other2:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <NavLink to="/mesin" className={({isActive}) => isActive ? Active : inActive }>Mesin</NavLink>
              </li>
              <li>
                <NavLink to="/roda" className={({isActive}) => isActive ? Active : inActive }>Roda</NavLink>
              </li>
              <li>
                <NavLink to="/bohlam" className={({isActive}) => isActive ? Active : inActive }>Bohlam</NavLink>
              </li>
              <li>
                <NavLink to="/baterai_and_sekring" className={({isActive}) => isActive ? Active : inActive }>Baterai & sekring</NavLink>
              </li>
              <li>
                <NavLink to="/rantai" className={({isActive}) => isActive ? Active : inActive }>Rantai</NavLink>
              </li>
            </ul>
          </div>
        </div>
